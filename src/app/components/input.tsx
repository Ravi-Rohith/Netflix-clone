...
const Input: React.FC<InputProps> = ({ label, id, type, onchange,value }) => {
    return (
        <div className="relative">
            ...
            <input id={id} value={value} onChange={onchange} className="username block rounded-md pt-6 pb-1 px-6 w-full text-md text-white bg-neutral-700 appearance-none focus:outline-none focus:ring-0 peer" type={type} placeholder=" " />
